...
public class ArcProgress extends View {
    ...
    private final float default_central_text_size;
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_central_text_size = Utils.sp2px(getResources(), 13);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        centralTextSize = attributes.getDimension(R.styleable.ArcProgress_arc_central_text_size, default_central_text_size);
        centralText = attributes.getString(R.styleable.ArcProgress_arc_central_text);
    }
    ...
    public float getCentralTextSize() {
        return centralTextSize;
    }

    public void setCentralTextSize(float centralTextSize) {
        this.centralTextSize = centralTextSize;
        this.invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String text = getCentralText();
        if (!TextUtils.isEmpty(text)) {
            textPaint.setColor(textColor);
            textPaint.setTextSize(getCentralTextSize());
