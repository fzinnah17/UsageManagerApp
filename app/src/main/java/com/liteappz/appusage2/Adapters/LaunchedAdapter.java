...
public class LaunchedAdapter extends RecyclerView.Adapter<LaunchedAdapter.ViewHolder> {

    private List<AppData> mData;
    private WeakReference<Context> mContext;

    public LaunchedAdapter(Context mContext) {
...
//    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_times_launched, viewGroup, false);
